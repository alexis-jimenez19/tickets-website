...
/* Boletos */
$app->get('/boletos', 'BoletoController@index'); //se puede obtener todos los boletos
$app->get('/boletos/{boletos}', 'BoletoController@show');//Se puede obtener un evento en especifico
